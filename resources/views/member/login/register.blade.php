        ...
        <div class="container">
            ...
            <form>
                <div class="form-group">
                    <label for="number">註冊帳號(請以E-mail註冊)</label>
                    <input type="email" ng-model="contCtrl.model.user.account" class="form-control" id="number" aria-describedby="emailHelp" placeholder="必填">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="password" ng-model="contCtrl.model.user.password" class="form-control" id="password" placeholder="必填">
                </div>
                <div class="form-group">
                    <label for="confirmPassword">確認密碼</label>
                    <input type="password" ng-model="contCtrl.model.user.password_confirm" class="form-control" id="confirmPassword" placeholder="必填">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" ng-model="contCtrl.model.user.cellPhone" class="form-control" id="mobilePhone" placeholder="">
                </div>
                ...
                <div class="form-group ">
                    <label for="companyTitle">公司抬頭</label>
                    <input type="text" ng-model="contCtrl.model.user.companyTitle" class="form-control" id="companyTitle" placeholder="">
                </div>
                <div class="form-group">
                    <label for="companyID">統一編號</label>
                    <input type="text" ng-model="contCtrl.model.user.taxId" class="form-control" id="companyID" placeholder="">
                </div>
                ...
                <div class="footerLinkBox">
                    <a class="signIn" href="/member/login">返回登入</a>
