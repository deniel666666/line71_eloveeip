        ...
        <div class="container">
            ...
            <form>
                <div class="form-group">
                    ...
                    <input type="email" ng-model="contCtrl.model.account" class="form-control" id="number" aria-describedby="emailHelp" placeholder="帳號為Email格式">
                </div>
                
                <button type="submit" ng-click="contCtrl.forgetPw()" class="btn btn-primary signInBtn">繼續</button>

                <a class="btn btn-block memberRegisteredBtn" href="/member/login">返回登入</a>
            </form>
        </div>
    </div>
