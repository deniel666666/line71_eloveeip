		...
		<div class="row bg-light no-gutters pageHeader">
		    <div class="col-lg-12 clearfix mb-2">
		        <div class="float-left">
		            <select class="use-form-control" style="width: 110px;" ng-model='contCtrl.selectSearchItem' ng-options="option.conta_item_id as option.conta_item_name for option in contCtrl.contactItem">
		                <option ng-selected="true" value="">搜尋項目</option>
		            </select>
		            <input class="use-form-control" style="width: 200px;" type='text' ng-model='contCtrl.searchText' />
		    ...
		    <table class="table table-bordered admin-table-rwd form">
				...
				<tbody>
					<tr ng-repeat="item in contCtrl.contact">
			            ...
			            <td data-th="日期"><a class="editInfor" href="" ng-click="contCtrl.go_eidt(item.conta_id)"><span ng-bind="contCtrl.formatDate(item.conta_datetime)"></span></a></td>
			            <td data-th="姓名"><a class="editInfor" href="" ng-click="contCtrl.go_eidt(item.conta_id)"><span ng-bind="item.conta_name"></span></a></td>
			            <td data-th="聯絡電話"> <span ng-bind="item.conta_phone"></span></td>
			            <td data-th="Email"><span ng-bind="item.conta_email"></span></td>
			            <td data-th="詢問項目"><span ng-bind="item.contact_item.conta_item_name"></span></td>
			            <td data-th="詢問內容"><span ng-bind="item.conta_cont"></span></td>
			            <td data-th="語系"><span ng-bind="contCtrl.langs[item.lang_id-1].lang_word"></span></td>
					</tr>
				</tbody>
			</table>
