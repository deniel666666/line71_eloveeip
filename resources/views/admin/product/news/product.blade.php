            ...
            <table class="table table-bordered admin-table-rwd form">
              ...
              <tbody>
                    <tr ng-repeat="(key ,item) in contCtrl.items">
                        ...
                        <td data-th="主列表(編輯)"><a class="editInfor w-100 d-inline-block" href="/admin/product/edit/detail/{{$productNum}}/@{{item.prod_id}}"><span ng-bind="item.prod_name"></span></a></td>
                        <td data-th="特性說明"><span ng-bind="item.prod_subtitle"></span></td>
