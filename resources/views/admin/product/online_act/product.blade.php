            ...
            <table class="table table-bordered admin-table-rwd form">
              <thead>
                    <tr class="admin-tr-only-hide">
                        ...
                        <th scope="col">行銷主題</th>
                        <th scope="col">年度波次</th>
              ...
              <tbody>
                    <tr ng-repeat="(key ,item) in contCtrl.items">
                        ...
                        <td data-th="行銷主題"><a class="editInfor w-100 d-inline-block" href="/admin/product/edit/detail/{{$productNum}}/@{{item.prod_id}}" target="_blank"><span ng-bind="item.prod_name"></span></a></td>
                        <td data-th="年度波次" ng-bind="item.prod_subtitle"></td>
