...
<div class="w-100 position-relative">
    ...
    <!-- 全版圖右字 tmp_full_img_right_text -->
    <section class="box-home-4 item-home">
        <div class="txt-content color-control 
        			...
        			bg-{{$cmsItem['template']['bg_color'] ?? '' }} color-{{$cmsItem['template']['tilte_color'] ?? '' }} bg-pc-#none">
            <div class="txt w-100">
        ...
        <div class="img-content" style="background-image:url('{{$cmsItem['imageSrc'] ?? '' }}')">
