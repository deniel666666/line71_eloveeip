...
<div class="row m-0">
    ...
    <div class="col-6 mb-2"> 
        <span class="use-sp-title">大標題字色(請輸入#字號+6碼的色號)</span>
    ...
    <div class="col-6 mb-2"> 
        <span class="use-sp-title">副標題背景色(請輸入#字號+6碼的色號)</span>
        <input class="form-control form-control-use line-style" type='text' ng-model='contCtrl.editItem.template.tilte_second_bg_color' 
               ng-blur="contCtrl.modifyItem(contCtrl.editItem, 2)" ng-focus="contCtrl.textRecording(contCtrl.editItem)"/>
    </div>
    <div class="col-6 mb-2"> 
        <span class="use-sp-title">副標題字色(請輸入#字號+6碼的色號)</span>
        <input class="form-control form-control-use line-style" type='text' ng-model='contCtrl.editItem.template.tilte_second_color' 
               ng-blur="contCtrl.modifyItem(contCtrl.editItem, 2)" ng-focus="contCtrl.textRecording(contCtrl.editItem)"/>
    </div>
    <hr class="col-12">

    <div class="col-12 mb-2"> 
        <span class="use-sp-title">說明文字1</span><span class="cms mark-use">可輸入&lt;br&gt;進行強制換行</span>
    ...
    <div class="col-6 mb-2"> 
        <span class="use-sp-title">說明文字1字色(請輸入#字號+6碼的色號)</span>
        <input class="form-control form-control-use line-style" type='text' ng-model='contCtrl.editItem.template.tilte_sub_color' 
               ng-blur="contCtrl.modifyItem(contCtrl.editItem, 2)" ng-focus="contCtrl.textRecording(contCtrl.editItem)"/>
    </div>
    <hr class="col-12">

    <div class="col-12 mb-2"> 
        <span class="use-sp-title">說明文字2</span><span class="cms mark-use">可輸入&lt;br&gt;進行強制換行</span>
        <textarea class="form-control form-control-use line-style" type='text' rows="4" 
               ng-model='contCtrl.editItem.template.tilte_sub2' 
               ng-blur="contCtrl.modifyItem(contCtrl.editItem, 2)" ng-focus="contCtrl.textRecording(contCtrl.editItem)"/>
        </textarea>
    </div>
    <div class="col-6 mb-2"> 
        <span class="use-sp-title">說明文字2背景色(請輸入#字號+6碼的色號)</span>
        <input class="form-control form-control-use line-style" type='text' ng-model='contCtrl.editItem.template.tilte_sub2_bg_color' 
               ng-blur="contCtrl.modifyItem(contCtrl.editItem, 2)" ng-focus="contCtrl.textRecording(contCtrl.editItem)"/>
    </div>
    <div class="col-6 mb-2"> 
        <span class="use-sp-title">說明文字2字色(請輸入#字號+6碼的色號)</span>
        <input class="form-control form-control-use line-style" type='text' ng-model='contCtrl.editItem.template.tilte_sub2_color' 
               ng-blur="contCtrl.modifyItem(contCtrl.editItem, 2)" ng-focus="contCtrl.textRecording(contCtrl.editItem)"/>
    </div>
</div>
