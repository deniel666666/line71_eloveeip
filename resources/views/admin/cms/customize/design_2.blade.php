        ...
        <div class="row border p-2">
            ...
            <div class="col-6">
                <div class="mb-2">
                    ...
                    <p class="mark-use mb-3">建議尺寸：1920*960px</p>
                </div>
            </div>
            <div class="col-6">
        ...
        <div class="row border p-2">
            ...
            <div class="col-6">
                <div class="mb-4">
                    <span class="spanTitle">區塊背景色：(請輸入#字號+6碼的色號)</span>
                    <input class="form-control" type='text' 
                        ng-model='contCtrl.items[3].template.bg_color' ng-blur="contCtrl.modifyItem(contCtrl.items[3],2)" 
                        ng-focus="contCtrl.textRecording(contCtrl.items[3])"/>
                </div>

                <div class="row mb-4">
                    <div class="col-12">
                        <span class="spanTitle">標題：</span>
                        <input class="form-control mb-2" type='text' 
                            ng-model='contCtrl.items[3].template.tilte_main' ng-blur="contCtrl.modifyItem(contCtrl.items[3],2)" 
                            ng-focus="contCtrl.textRecording(contCtrl.items[3])"/>
                    </div>
                    <div class="col-6">
                        <span class="spanTitle">標題背景色：(請輸入#字號+6碼的色號)</span>
                        <input class="form-control mb-2" type='text' 
                            ng-model='contCtrl.items[3].template.tilte_main_bg' ng-blur="contCtrl.modifyItem(contCtrl.items[3],2)" 
                            ng-focus="contCtrl.textRecording(contCtrl.items[3])"/>
                    </div>
                    <div class="col-6">
                        <span class="spanTitle">標題字色：(請輸入#字號+6碼的色號)</span>
                        <input class="form-control mb-2" type='text' 
                            ng-model='contCtrl.items[3].template.tilte_main_color' ng-blur="contCtrl.modifyItem(contCtrl.items[3],2)" 
                            ng-focus="contCtrl.textRecording(contCtrl.items[3])"/>
                    </div>

                    <div class="col-12">
                        <span class="spanTitle">內容：</span>
                        <div class="mb-2" summernote ng-model="contCtrl.items[3].cont.text" config="noteOptions" int="3"></div>
                        <span class="spanTitle">內容字色：(請輸入#字號+6碼的色號)</span>
                        <input class="form-control mb-2" type='text' 
                            ng-model='contCtrl.items[3].template.content_color' ng-blur="contCtrl.modifyItem(contCtrl.items[3],2)" 
                            ng-focus="contCtrl.textRecording(contCtrl.items[3])"/>
                    </div>
                </div>
            </div>
            <div class="col-6">
                <div class="mb-2">
                    ...
                    <p class="mark-use mb-3">建議尺寸：950*740px</p>
                </div>
