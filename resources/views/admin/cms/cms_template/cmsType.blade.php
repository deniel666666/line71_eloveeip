        ...
        <table class="table table-bordered admin-table-rwd form">
            <thead>
                <tr class="admin-tr-only-hide">
                    ...
                    <th class="w-200px">類別名稱</th>
                    <th class="w-150px">內容(修改)</th>
            ...
            <tbody>
                <tr ng-repeat="(key,item) in contCtrl.items">
                    ...
                    <td data-th="類別名稱"><a class="editInfor" href="" data-toggle="modal" data-target="#itemData" ng-click='contCtrl.edit(item)'>@{{item.cms_type_name}}</a></td>
                    <th data-th="內容(修改)"><a href="" ng-click='contCtrl.go_edit(item.id)'>編輯</a></th>
        ...
        ////////////////////////////////////////////////////////////////////////////////////////
            ...
            self.addItem = function() {
                ...
                if (typeof(self.itemData.cms_type_name) == 'undefined' || self.itemData.cms_type_name == '') {
                    $.toaster({message:"類別名稱為必填", priority:'warning'});
                    return false;
                }
