...
<div class="container-fluid">
	...
	<div>
		<table class="table">
			...
			<tbody>
				<tr ng-repeat="item in contCtrl.orderCont.subscribe">
					<th>@{{item.journalName}}</th>
	...
	<div class="row">
		<div class="col-12">
			運送方式 :  @{{contCtrl.orderCont.fare}}(@{{contCtrl.orderCont.fare.fareCost}}元)
		</div>
	</div>
	...
	<div class="row">
		<div class="col-12">
			總金額 :   @{{contCtrl.orderCont.totalPrice}}元
		</div>
	</div>
    ...
    <script type="text/javascript">
        ...
        app.controller('ContentController',['$http',function($http){
			...
			self.getOrder = function(){
				$http({
					method : "get",
					url : "/admin/api/journalOrder/"+self.orderId,
			...
			self.payStatusChange = function(){
				...
				$http({
					method : "put",
					url : "/admin/api/journalOrder/"+self.orderId+"/payStatus",
			...
			self.shippingStatusChange = function(){
				...
				$http({
					method : "put",
					url : "/admin/api/journalOrder/"+self.orderId+"/shippingStatus/",
