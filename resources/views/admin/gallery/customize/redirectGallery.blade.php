		...
		<div class="row bg-light no-gutters pageHeader">
	        <div class="col-lg-8 clearfix order-1 mb-2">
	            <div class="float-left">
	                ...
	                <input class="use-form-control w-180px" type='text' ng-model='contCtrl.searchText' placeholder="請填入搜尋比對網址" />
		    ...
		    <table class="table table-bordered admin-table-rwd">
				...
				<tbody>
					<tr ng-repeat="(key,item) in contCtrl.galleryList">
						...
						<td data-th="跳轉網址">
							<a class="editInfor w-100 d-inline-block" href="" ng-bind="item.gallery_cont.sub_title" ng-click="contCtrl.go_edit(item.gallery_id)"></a>
						</td>
