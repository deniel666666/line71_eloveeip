...
(function (global, factory) {
  ...
  var dialog = renderer.create('<div class="modal" aria-hidden="false" tabindex="-1" role="dialog"/>', function ($node, options) {
      ...
      $node.html([
          ...
          '  </div>',
          '</div>'
      ].join('') + '<div class="note_editor_block" aria-label="'+ options.title +'" onclick="close_note_editor(\''+ options.title +'\')"></div>');
  });
...
// console.log('nextPara=>'+ editable.innerHTML )
  ...
  var ImageDialog = /** @class */ (function () {
      ...
      ImageDialog.prototype.initialize = function () {
          ...
          var body = [
              ...
              // -------------------
            //   '<div class="form-group note-group-image-url" style="overflow:auto;">',
            //   '<label class="note-form-label">' + '連結網址' + '</label>',
            //   '<input class="note-image-url form-control note-form-control note-input ',
            //   ' col-md-12" type="text" />',
              // -------------------
...
$(document).on('show.bs.modal', '.note-editor .modal', function (e) {
    aria_label = e.currentTarget.ariaLabel;
    $('.note-editor .note_editor_block[aria-label="'+ aria_label +'"]').show();
    setTimeout(function(){
        if($("body:has('.note-editor .modal.show')").length>0){
            $('.modal.fade.show').css({'overflow-y':'hidden'});
        }
    }, 300);
});
function close_note_editor(aria_label){
    $('.note-editor .modal[aria-label="'+ aria_label +'"]').modal('hide');
    $('.modal.fade.show').css({'overflow-y':'auto'});
}