    ...
    'imageAttributes': function (context) {
      ...
      this.initialize = function () {
        ...
        var body = '<ul class="nav note-nav nav-tabs note-nav-tabs">' +
                      '<li class="nav-item note-nav-item d-none"><a class="nav-link note-nav-link" href="#note-imageAttributes-' + i + '" data-toggle="tab">' + lang.imageAttributes.tabImage + '</a></li>' +
                      '<li class="nav-item note-nav-item d-none"><a class="nav-link note-nav-link" href="#note-imageAttributes-attributes-' + i + '" data-toggle="tab">' + lang.imageAttributes.tabAttributes + '</a></li>' +
                      '<li class="nav-item note-nav-item active"><a class="nav-link note-nav-link active" href="#note-imageAttributes-link-' + i + '" data-toggle="tab">' + lang.imageAttributes.tabLink + '</a></li>';
        if (options.imageAttributes.disableUpload == false) {
           body +=    '<li class="nav-item note-nav-item  d-none"><a class="nav-link note-nav-link" href="#note-imageAttributes-upload-' + i + '" data-toggle="tab">' + lang.imageAttributes.tabUpload + '</a></li>';
        }
        body +=     '</ul>' +
          ...
          // Tab 2
                    ...
                    '</div>' +
          // Tab 3
                    '<div class="nav note-nav nav-tabs note-nav-tabs border-0" id="note-imageAttributes-link-' + i + '">' +
                      '<div class="note-form-group form-group note-group-imageAttributes-link-href w-100">' +
                        ...
                        '</div>' +
                      '</div>' +
                      '<div class="note-form-group form-group note-group-imageAttributes-link-target w-100">' +
          ...
          ui.onDialogShown(self.$dialog, function () {
            ...
            $editBtn.click( function (e) {
              ...
              deferred.resolve({
                ...
                context.triggerEvent('change', $editable.html(), change_type='plugin_set');
              });
            });
