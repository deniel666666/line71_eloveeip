		...
		buildValue(valObj) {
			...
			const valHtml = '<div class="select-mania-value" data-value="'+valObj.value+'">'+
				...
				'<div class="select-mania-value-clear">'+
					'<i class="select-mania-value-clear-icon icon-cross" onclick="selectClick()"></i>'+
				'</div>'+
			'</div>';
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ buildItem
		...
		buildItem($optionEl, forceDisabled) {
			...
			//build item html
			const $item = $('<div class="select-mania-item" data-value="'+optionEl.value+'" onclick="selectClick()"></div>');
			//if option is hidden
