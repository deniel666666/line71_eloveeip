...
Route::group(['langeId'=>1], function () {
    ...
    Route::get('/faq',                                  __APP__.'\Client\FaqController@index');
    Route::get('/faq/{cate_tag_id}',                    __APP__.'\Client\FaqController@index');
    Route::get('/faq/{cate_tag_id}/{page}',             __APP__.'\Client\FaqController@index');
    Route::get('/case',                                 __APP__.'\Client\CaseController@index');
    Route::get('/case/{cate_tag_id}',                   __APP__.'\Client\CaseController@index');
    Route::get('/case-info/{prod_id}',                  __APP__.'\Client\CaseController@case_info');
    ...
    Route::get('/{id}/online_page.html',                __APP__.'\Client\OnlineController@online_page_by_id');
...
Route::group(['middleware' => 'role:admin,manager'], function () {
    ...
    Route::get('/admin/go_line_page',           __APP__.'\Api\MailboxApiController@goLinePage');            // go to line page(LINE Notify)
    Route::get('/admin/line_auth',              __APP__.'\Api\MailboxApiController@lineAuth');              // line auth callback(LINE Notify)
    Route::get('/admin/go_line_page_message',   __APP__.'\Api\MailboxApiController@goLinePage_message');    // go to line page(LINE Message)
    Route::get('/admin/line_auth_message',      __APP__.'\Api\MailboxApiController@lineAuth_message');      // line auth callback(LINE Message)
    ...
    Route::post('/admin/api/product/copy', __APP__.'\Api\ProductApiController@copy');      //copy products
